  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center pt-20">
        ...
        >
          <div className={"h-auto w-full md:w-8/12 p-4 bg-[#262526] " + styles.div_subtitles }>
            <h3 className="flex text-xl font-bold"><img src="/images/apoyo_grafico/circle_start.png" alt="" /> &nbsp; MINIMALISMO</h3>
        ...
        >
          <div className={"h-auto w-full md:w-8/12 p-4 bg-[#262526] " + styles.div_subtitles}>
            <h3 className="flex text-xl font-bold"> <img src="/images/apoyo_grafico/circle_start.png" alt="" /> &nbsp; INDUSTRIAL</h3>
            <p className="pt-3 xl:pl-8 ">
        ...
        >
          <div className={"h-[265px] w-full md:w-8/12 p-4 bg-[#262526] " + styles.div_subtitles}>
            <h3 className="flex text-xl font-bold"><img src="/images/apoyo_grafico/circle_start.png" alt="" /> &nbsp; RÚSTICO</h3>
            <p className="pt-3 xl:pl-8 ">
      ...
      <div className="ml-1 md:ml-0 w-full flex flex-col items-center justify-center mt-20">
        ...
        <div className="md:bg-[#E20613] w-72 md:w-[62%] h-24 gap-2 md:gap-8 flex flex-col md:flex-row items-center justify-center">
          <input className="w-11/12 md:ml-7 my-2 p-2 md:w-5/12 " type="email" placeholder="E-mail" />
          <button className={"bg-[#E20613] md:bg-[#262526] md:mr-7 w-8/12 m-2 p-2 md:w-6/12 h-10"}>SUSCRÍBETE</button>
        </div>
      </div>
    </>
  );
