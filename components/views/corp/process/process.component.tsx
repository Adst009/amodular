...
function Process() {
  return (
    <div className={"flex-col sm:flex-col pt-36 md:mb-[-200px] lg:mb-[-300px] md:flex-row lg:flex-row xl:flex items-center content-center " + styles.section}>
      <div className={"relative indez-30 bg-[#323032] pl-10 lg:pl-32 md:w-8/12"}>
        ...
        <p className="text-white my-4 w-8/12 md:w-6/12 pl-2 ">
