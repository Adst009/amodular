  ...
  return (
    <div className={`w-full flex-col mt-[-110px] ${route.asPath === "/corp" ? "bg-[url('/images/corp/background.png')]" :  "bg-[url('/images/home/background.png')]"} ` + styles.container}>
      <div className={"flex flex-col content-start items-start pb-10 pt-[140px] " + styles.container_text}>
        <h1 className={"text-5xl ml-2 md:ml-44 md:text-9xl font-black text-white " + styles.title_main}>{route.asPath === "/corp" ? "TU OFICINA" : "LA COCINA"}</h1>
        <h3 className={"text-5xl ml-2 md:ml-44 md:text-9xl pl-2 font-medium text-white " + styles.title_main}>{route.asPath === "/corp" ? "corporativa" : "de tus sueños"}</h3>
